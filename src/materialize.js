    ...
    switch (p(t, e)) {
      case "transform":
        return (function(t, i) {
          ...
          for (var s = [], o = [], a = [], r = /(\w+)\((.+?)\)/g;
            (s = r.exec(t));) o.push(s[1]), a.push(s[2]);
  ...
  function O(t) {
    ...
    function c(e) {
      for (var t = 0, i = {}, n = k.animations, s = n.length; t < s;) {
        ...
        for (
          var r = Math.min(Math.max(e - h.start - h.delay, 0), h.duration) / h.duration, d = isNaN(r) ? 1 : h.easing(r, h.elasticity), r = h.to.strings, u = h.round, l = [], c = void 0, c = h.to.numbers.length, p = 0; p < c; p++
        ) {
          var v = void 0,
            v = h.to.numbers[p],
            f = h.from.numbers[p],
                ...
                !0 !== this.isOpen &&
                  ((this.isOpen = !0),
                    ...
                    (o.remove(this.el), o({
                      ...
                      duration: 0,
                      easing: "easeOutQuad"
                    }), this._enableBodyScrolling(), (this._overlay.style.display = "none")) :
