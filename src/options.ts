...
import { logDebugMessage, logErrorMessage, saveDebugModeSetting, restoreDebugModeSetting } from "./library/debug";
...
async function fetchS3FileContent(
  ...
  try {
    ...
    logErrorMessage("Failed to fetch S3 file content:", error);
    throw error;
  }
}
